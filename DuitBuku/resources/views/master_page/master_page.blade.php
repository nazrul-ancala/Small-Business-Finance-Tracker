...
<head>
    ...
    <meta charset="utf-8" />
    <base href="/">
    <title>@yield('page_title', 'DuitBuku')</title>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ Auth::user()->role ?? 'Owner' }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-profile.html"><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Balance : <b>RM {{ number_format($navbar->getCurrentBalance(), 2) }}</b></span></a>
                        ...
                        <span class="dropdown-item disabled" style="pointer-events:none;"><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Lock screen</span></span>
                ...
                <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-start">
                            ...
                            <span class="d-block fs-14 sidebar-user-name-sub-text"><i class="ri ri-circle-fill fs-10 text-success align-baseline"></i> <span class="align-middle">{{ Auth::user()->role ?? 'Owner' }}</span></span>
                        </span>
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ $navbar->isActive('dashboard') }}" href="{{ route('dashboard') }}">
                                <i class="ti ti-layout-dashboard"></i> <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="menu-title"><span>Money in &amp; out</span></li>

                        <li class="nav-item {{ $navbar->txnIsExpanded() }}">
                            <a class="nav-link menu-link" href="#sidebarTxn" data-bs-toggle="collapse" role="button" aria-expanded="{{ $navbar->txnIsExpanded() ? 'true' : 'false' }}" aria-controls="sidebarTxn">
                                <i class="ti ti-arrows-exchange"></i> <span>Transactions</span>
                            </a>
                            <div class="collapse menu-dropdown {{ $navbar->txnIsExpanded() }}" id="sidebarTxn">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="{{ route('transactions.all') }}" class="nav-link {{ $navbar->isActive('transactions.all') }}">All transactions</a></li>
                                    <li class="nav-item"><a href="{{ route('transactions.recurring') }}" class="nav-link {{ $navbar->isActive('transactions.recurring') }}">Recurring entries</a></li>
                                    <li class="nav-item"><a href="{{ route('transactions.categories') }}" class="nav-link {{ $navbar->isActive('transactions.categories') }}">Categories</a></li>
                                </ul>
                            </div>
                        </li>

                        <li class="nav-item {{ $navbar->invIsExpanded() }}">
                            ...
                            <div class="collapse menu-dropdown {{ $navbar->invIsExpanded() }}" id="sidebarInvoices">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="{{ route('invoices.all') }}" class="nav-link {{ $navbar->isActive('invoices.all') }}">All invoices</a></li>
                                    <li class="nav-item"><a href="{{ route('invoices.customers') }}" class="nav-link {{ $navbar->isActive('invoices.customers') }}">Customers</a></li>
                                    <li class="nav-item"><a href="{{ route('invoices.payments') }}" class="nav-link {{ $navbar->isActive('invoices.payments') }}">Payment records</a></li>
                                </ul>
                            </div>
                        </li>

                        <li class="nav-item {{ $navbar->drawIsExpanded() }}">
                            <a class="nav-link menu-link" href="#sidebarDrawings" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDrawings">
                                <i class="ti ti-user-dollar"></i> <span>Owner drawings</span>
                            </a>
                            <div class="collapse menu-dropdown {{ $navbar->drawIsExpanded() }}" id="sidebarDrawings">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="{{ route('drawings.all') }}" class="nav-link {{ $navbar->isActive('drawings.all') }}">All drawings</a></li>
                                    <li class="nav-item"><a href="{{ route('drawings.salary') }}" class="nav-link {{ $navbar->isActive('drawings.salary') }}">Salary summary</a></li>
                                </ul>
                            </div>
                        </li>

                        <li class="menu-title"><span>Planning</span></li>

                        <li class="nav-item {{ $navbar->cfIsExpanded() }}">
                            <a class="nav-link menu-link" href="#sidebarCashflow" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCashflow">
                                <i class="ti ti-calendar-stats"></i> <span>Cashflow forecast</span>
                            </a>
                            <div class="collapse menu-dropdown {{ $navbar->cfIsExpanded() }}" id="sidebarCashflow">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="{{ route('cashflow.calendar') }}" class="nav-link {{ $navbar->isActive('cashflow.calendar') }}">30-day calendar</a></li>
                                    <li class="nav-item"><a href="{{ route('cashflow.bills') }}" class="nav-link {{ $navbar->isActive('cashflow.bills') }}">Upcoming bills</a></li>
                                    <li class="nav-item"><a href="{{ route('cashflow.income') }}" class="nav-link {{ $navbar->isActive('cashflow.income') }}">Expected income</a></li>
                                    <li class="nav-item"><a href="{{ route('cashflow.days') }}" class="nav-link {{ $navbar->isActive('cashflow.days') }}">Days cash left</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item {{ $navbar->plIsExpanded() }}">
                            <a class="nav-link menu-link" href="#sidebarPL" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPL">
                                <i class="ti ti-chart-bar"></i> <span>P&amp;L snapshot</span>
                            </a>
                            <div class="collapse menu-dropdown {{ $navbar->plIsExpanded() }}" id="sidebarPL">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="{{ route('pl.month') }}"     class="nav-link {{ $navbar->isActive('pl.month') }}">This month</a></li>
                                    <li class="nav-item"><a href="{{ route('pl.quarterly') }}" class="nav-link {{ $navbar->isActive('pl.quarterly') }}">Quarterly view</a></li>
                                    <li class="nav-item"><a href="{{ route('pl.yearly') }}"    class="nav-link {{ $navbar->isActive('pl.yearly') }}">Yearly summary</a></li>
                                </ul>
                            </div>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link {{ $navbar->isActive('business.health') }}" href="{{ route('business.health') }}">
                                <i class="ti ti-heart-rate-monitor"></i> <span>Business health</span>
